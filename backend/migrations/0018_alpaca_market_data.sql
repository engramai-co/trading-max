...
CREATE TABLE integration_settings_v3 (
    integration_id TEXT PRIMARY KEY,
    provider TEXT NOT NULL CHECK (provider IN ('trading212', 'deepseek', 'openai', 'opencode', 'alpaca')),
    profile TEXT,
...
INSERT INTO integration_settings_v3 (
...
ALTER TABLE integration_settings_v3 RENAME TO integration_settings;
