...
export TRADING_MAX_WORKER_ID="${TRADING_MAX_WORKER_ID:-trading_max-mac-mini}"
exec "$SERVICE_ROOT/app/.venv/bin/python" -m services.api.trading_max_api.worker_main
